...
parent_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(src_file_path))))
...
class DINOSingleImageTokenizer(BaseModule):
    ...
    def configure(self) -> None:
        self.model: ViTModel = ViTModel(
            ViTModel.config_class.from_pretrained(parent_dir+ "/checkpoints/config.json",)
        )
